    ...
    return  (
            <div>
                ...
                <Stack spacing={3}>
                    ...
                    <Input onChange={(e: { target: { value: string; }; }) => newLocation.location_geolocation.lat= e.target.value}  name="lat" placeholder='lat' size='md' isInvalid errorBorderColor='red.300' _placeholder={{ opacity: 0.4, color: 'orange' }}  ></Input>
                    <Input  onChange={(e: { target: { value: string; }; }) => newLocation.location_geolocation.lng= e.target.value}  name="lng" placeholder='lng' size='md' isInvalid errorBorderColor='red.300' _placeholder={{ opacity: 0.4, color: 'orange' }}  ></Input>
